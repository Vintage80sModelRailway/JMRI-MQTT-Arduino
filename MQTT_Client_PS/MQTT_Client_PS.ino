...
void InitialiseConfig() {
  ...
  //Sensors - Name, Pin, JMRIId, IsInverted = false, Pinmode = INPUT, Lastknownvalue = 0
    ...
    Sensors[9] = Sensor("CD Pi end CW", 32, "1017", false,INPUT_PULLUP);
    Sensors[10] = Sensor("CD Pi end AC", 33, "1018", false,INPUT_PULLUP);
    Sensors[11] = Sensor("CD Pi end incline", 28, "1019", false,INPUT_PULLUP);
    Sensors[12] = Sensor("IR CW Yard Entry", 29, "1020", true);
    Sensors[13] = Sensor("IR CW Yard entry lower", 27, "1021", true);
    Sensors[14] = Sensor("IR AC Yard Exit", 26, "1022", true);
    Sensors[15] = Sensor("IR AC Yard Bypass stopping sensor", 36, "1023", true);
    Sensors[16] = Sensor("CD AC Yard bypass Pi End", 25, "1024", false,INPUT_PULLUP);
    Sensors[17] = Sensor("CD CW Yard bypass Pi end", 24, "1025", false,INPUT_PULLUP);
    Sensors[18] = Sensor("CD Incline Top", 22, "1026", false,INPUT_PULLUP);
    Sensors[19] = Sensor("CD corner 2 unused 1", 23, "1027", false,INPUT_PULLUP);
